...
import (
	...
	//"github.com/btceasypay/btp-desktop-wallet/util/ssh/terminal"

	"github.com/btceasypay/btp-desktop-wallet/internal/legacy/keystore"

	hdkeychain "github.com/btceasypay/bitcoinpay/crypto/seed"
)
...
func Seed(reader *bufio.Reader) ([]byte, error) {
	...
	if !useUserSeed {
		seed, err := hdkeychain.GenerateSeed(uint16(32))
		if err != nil {
			return nil, err
		}
