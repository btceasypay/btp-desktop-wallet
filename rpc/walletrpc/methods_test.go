...
import (
	...
	qjson "github.com/btceasypay/btp-desktop-wallet/json"
...
func openWallet() (*wallet.Wallet, error) {
	...
	tomlpath := "/Users/luoshan/GolandProjects/btp-wallet/config.toml"
	pubpass := "public"
	dbpass := "123456"
...
func test_wallet_getlisttxbyaddr(w *wallet.Wallet) (interface{}, error) {
	cmd := &btpjson.GetListTxByAddrCmd{
