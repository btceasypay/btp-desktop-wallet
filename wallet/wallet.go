// Copyright (c) 2020-2021 The btp developers
...
import (
	...
	corejson "github.com/btceasypay/bitcoinpay/core/json"
	...
	wt "github.com/btceasypay/btp-desktop-wallet/types"

	"github.com/btceasypay/btp-desktop-wallet/config"
	clijson "github.com/btceasypay/btp-desktop-wallet/json"
	...
	"github.com/btceasypay/btp-desktop-wallet/walletdb"
...
func (w *Wallet) SendPairs(amounts map[string]types.Amount,
	...
	if err != nil {
		if err == txrules.ErrAmountNegative {
			return "", btpjson.ErrNeedPositiveAmount
		}
		if waddrmgr.IsError(err, waddrmgr.ErrLocked) {
			return "", &btpjson.ErrWalletUnlockNeeded
		}
		switch err.(type) {
		case btpjson.RPCError:
			return "", err
		}

		return "", &btpjson.RPCError{
			Code:    btpjson.ErrRPCInternal.Code,
			Message: err.Error(),
		}
	}
	return *tx, nil
